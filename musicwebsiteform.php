  ...
  <nav class="navbar navbar-expand-sm bg-dark navbar-dark">
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="collapsibleNavbar">
        <ul class="navbar-nav">
          <li class="nav-item">
            <a class="nav-link" href="musicwebsiteform.html">Sign in / Application Form  <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" class="bi bi-globe2" viewBox="0 0 16 16">
          ...
          <li class="nav-item">
            <a class="nav-link" href="musicwebsiteinfopage.html">Lineup and info<svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" class="bi bi-file-person" viewBox="0 0 16 16">
                <path d="M12 1a1 1 0 0 1 1 1v10.755S12 11 8 11s-5 1.755-5 1.755V2a1 1 0 0 1 1-1h8zM4 0a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h8a2 2 0 0 0 2-2V2a2 2 0 0 0-2-2H4z"/>
                <path d="M8 10a3 3 0 1 0 0-6 3 3 0 0 0 0 6z"/>
              </svg></a>
          </li>
          <li class="nav-item">
              <a class="nav-link" href="#"> Basket <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" class="bi bi-bag" viewBox="0 0 16 16">
    ...
    <script type="text/javascript">
        ...
        listy += "Please fill in Full name\n"
        }



        else if(myForm.fname.value!=""){
        ...
        listy += "Please fill in Address\n"
    }

        else if(myForm.adr.value!=""){
            {document.getElementById("adr").style.border="2px solid green"}
        }

        if (myForm.city.value=="")
        {document.getElementById("city").style.border="2px solid red"
        listy += "Please fill in City\n"
    }
        ...
        listy += "Please fill in Age\n"
    }

        else if(myForm.age.value!=""){
        ...
        listy += "Please fill in Phone number\n"
    }

        else if(myForm.phonenumber.value!=""){
        ...
        if (listy.length > 0){
            //document.getElementById("davai").style.removeclass="btn btn-info"
            //document.getElementById("davai").style.background="btn btn-info"
            

        }

        return listy.length == 0;
        ...
        $(function(){
            ...
            $('#appform').on('submit',  function() {
                if ( ! hiya() ) {
                    ...
                    //$('#davai').removeClass('btn-primary');
                    $('#davai').addClass('btn-danger');
                   ...
                   // $('#davai').removeClass('btn-danger');
                    $('#davai').addClass('btn-primary');
                ...
                <form  name="myForm" id="appform" action="pagepost.php" method="POST"></form>
                    <div class="row">
                        <div class="col-50">
                            ...
                            <input type="text" id="city" name="city" placeholder="Truro">
                            <label for="city"><i class="fa fa-institution"></i> Age</label>
                            <input type="number" id="age" name="age" placeholder="65">
                            <label for="phonenumber">Phone number</label>
                                <input type="text" id="phonenumber" name="phonenumber" placeholder="07887634292">
                        </div>
                    </div>
                    <label for="gender">Choose your gender (Optional)</label>
                    <select type="date" name="gender" id="gender">
                    ...
                    <label>
                        <input type="checkbox" checked="checked" name="checkbox"> Check box to confirm all data entered is correct.
                    </label>
...
<footer class="bg-dark text-center text-white">
    ...
    <div class="container p-4 pb-0">
      ...
      <section class="mb-4">
        ...
        <!-- snapchat -->
        <a href="https://www.snapchat.com" role="button"
        ><svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor" class="bi bi-snapchat" viewBox="0 0 16 16">
    ...
    <!-- Grid container -->
    Thanks for visiting the website! Have a look at our outher social medias and hopefully see you guys again soon.
    <!-- Copyright -->
    <div class="text-center p-3" style="background-color: rgba(0, 0, 0, 0.2);">
      &copy; 2021 Copyright:
      <a class="text-white" href="https://youtbe.com/"></a>Ed is da best :)</a>
    </div>
    <!-- Copyright -->
  </footer>
